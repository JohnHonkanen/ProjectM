...
public:
	...
	*/
	...
	void CreateNewBuilding(Structure * object);
...
private:
	...
	map<string, BuildingObjectUniquePointer> buildingList;			// map struct used to store a structure related to a specific structure name from a file : original
