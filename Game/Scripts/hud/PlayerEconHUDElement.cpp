...
void PlayerEconHUDElement::Start()
{
	...
	// Player gold amount
	playerEconomy->SetGBAmount(200);
	playerGold = EHUD::TextWidget::Create(playerEconHUD, { 10, 16, 0, 0 }, "Player Gold Amount: " + to_string(playerEconomy->GetGBAmount()), "Game/Assets/Fonts/MavenPro-Regular.ttf", 16, 1, vec3(1, 1, 1));
...
{
	playerGold->text = "Player Gold Amount: " + to_string(playerEconomy->GetGBAmount());
}
